...
#
# Script generated by Vivado on Sun May 17 20:15:42 +0800 2026
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : sync_fifo_32x128.sh
...
#
# Usage        : sync_fifo_32x128.sh
#                sync_fifo_32x128.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sync_fifo_32x128.sh [-reset_run]
#                sync_fifo_32x128.sh [-reset_log]
#                sync_fifo_32x128.sh [-help]
#
...
#                script (type 'sync_fifo_32x128.sh -help' for more information).
#
...
# script info
echo -e "sync_fifo_32x128.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sync_fifo_32x128.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.sync_fifo_32x128 xil_defaultlib.glbl -o sync_fifo_32x128_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./sync_fifo_32x128_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key sync_fifo_32x128_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc sync_fifo_32x128_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sync_fifo_32x128.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sync_fifo_32x128.sh [-help]\n\
Usage: sync_fifo_32x128.sh [-step]\n\
Usage: sync_fifo_32x128.sh [-lib_map_path]\n\
Usage: sync_fifo_32x128.sh [-reset_run]\n\
Usage: sync_fifo_32x128.sh [-reset_log]\n\
Usage: sync_fifo_32x128.sh [-keep_index]\n\
Usage: sync_fifo_32x128.sh [-noclean_files]\n\n\
