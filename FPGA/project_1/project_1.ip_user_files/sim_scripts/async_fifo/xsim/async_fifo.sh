...
#
# Script generated by Vivado on Tue Apr 28 19:20:56 +0800 2026
...
# script info
echo -e "async_fifo.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_10 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot async_fifo xil_defaultlib.async_fifo xil_defaultlib.glbl -log elaborate.log
}
