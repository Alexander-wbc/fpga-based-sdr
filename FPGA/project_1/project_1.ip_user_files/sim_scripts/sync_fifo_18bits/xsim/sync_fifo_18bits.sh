...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_10 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sync_fifo_18bits xil_defaultlib.sync_fifo_18bits xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sync_fifo_18bits -key {Behavioral:sim_1:Functional:sync_fifo_18bits} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sync_fifo_18bits.wdb xsim.dir libdpi.so)
